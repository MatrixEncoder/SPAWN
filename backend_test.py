...
class SPAWNBackendTester:
    def __init__(self, base_url: str = "https://spawn-deploy.preview.emergentagent.com/api"):
...
def main():
    ...
    print("Testing backend at: https://spawn-deploy.preview.emergentagent.com/api")
    print()
