...
class SPAWNBackendTester:
    def __init__(self, base_url: str = "https://scan-scheduler.preview.emergentagent.com/api"):
...
def main():
    ...
    print("Testing backend at: https://scan-scheduler.preview.emergentagent.com/api")
    print()
